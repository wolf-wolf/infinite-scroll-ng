 ...
 */
angular.module(moduleName).directive('infiniteScrollbar', ['$timeout', 'DataMechanism', '$injector',
    function ($timeout, DataMechanism, $injector) {
        return {
            restrict: 'A',
            scope: {
                dataList: '=',                          // 数据
            ...
            link: function (scope, element, attr) {
                ...
                let utilService = $injector.get('utilService');
